...
unsigned int parse_options (simulation_parameters *sp, FILE *f) {
  ...
  while (! feof (f)) {
	...
	(((! strcmp (s,  "trials:")) && fscanf (f, "%u", &sp->number_of_trials)) ||
	 ...
	 ((! strcmp (s,  "frequency-a:")) && fscanf (f, "%lf", &sp->mutation_parameters.a_frequency)) ||
	 ((! strcmp (s,  "frequency-c:")) && fscanf (f, "%lf", &sp->mutation_parameters.c_frequency)) ||
	 ((! strcmp (s,  "frequency-g:")) && fscanf (f, "%lf", &sp->mutation_parameters.g_frequency)) ||
	 ((! strcmp (s,  "frequency-u:")) && fscanf (f, "%lf", &sp->mutation_parameters.u_frequency)) ||
