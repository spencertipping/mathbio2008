...
conditional_inline unsigned int choose_individual (fitness_vector *v) {
  ...
  if (v != NULL) {
    ...
    return random_integer () % v->length;
}
\end{ccode}
...
conditional_inline void perform_inheritance (
  ...
  if (normalized_random () < sp->g.recombination_rate) {
    ...
    // at random.
    unsigned int parent_1 = choose_individual (parent_fitness);
    ...
    while (parent_2 == parent_1)
      parent_2 = choose_individual (parent_fitness);
    ...
    unsigned int parent_index = choose_individual (parent_fitness);
