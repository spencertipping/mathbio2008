...
conditional_inline unsigned int choose_individual (double d, fitness_vector *v, population *p) {
...
\begin{ccode}
conditional_inline double diversifying_selection (population *p, unsigned int idx, simulation_parameters *sp) {
...
\begin{ccode}
conditional_inline void populate_parent_fitness (population *parents, simulation_parameters *sp) {
...
conditional_inline void consider_drift_on_fitness (population *parents, unsigned int generation,
...
\begin{ccode}
conditional_inline void print_sequences (population *p, FILE *f, bool packed) {
